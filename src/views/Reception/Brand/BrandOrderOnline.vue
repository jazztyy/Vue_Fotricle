<template>
  <section class="mx-5 rounded-lg">
    <ul class="flex justify-between py-5">
      <li>
        <router-link class="mb-5 md:mr-5 md:mb-0 p-5 text-3xl" to="/Brand/Order/Site">&lt; 點餐系統</router-link>
      </li>
      <li>
        <router-link class="mb-5 md:mr-5 md:mb-0 p-5 text-3xl" to="/Brand/Order/List">候餐列表 &gt;</router-link>
      </li>
    </ul>
        ...
        <tbody class="text-xl">
          ...
          >
            ...
            >
              ...
              >拒絕</button>
              <button class="btn-main px-10 py-5" @click="changeOrderPhase('Comfirm', order.Id)">接受</button>
            </td>
          </tr>
        </tbody>
      </table>
