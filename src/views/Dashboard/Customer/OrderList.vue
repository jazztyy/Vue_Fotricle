  ...
  <section class="lg:w-3/4 mx-5 shadow-lg">
    <ul class="flex justify-evenly text-center text-2xl">
      <li
        ...
        :class="{'bg-thirdcolor-400': currentPage === 'Checking', 'bg-maincolor-200': currentPage !== 'Checking'}"
      ...
      <li
        ...
        :class="{'bg-thirdcolor-400': currentPage === 'Established', 'bg-maincolor-200': currentPage !== 'Established'}"
      ...
      <li
        ...
        :class="{'bg-thirdcolor-400': currentPage === 'Completed', 'bg-maincolor-200': currentPage !== 'Completed'}"
      ...
      <li
        class="relative flex-1 rounded-t-lg bg-maincolor-200 text-thirdcolor-400 cursor-pointer"
        :class="{'bg-thirdcolor-400': currentPage === 'Success', 'bg-maincolor-200': currentPage !== 'Success'}"
      ...
      <li
        class="relative flex-1 rounded-t-lg bg-maincolor-200 text-thirdcolor-400 cursor-pointer"
        :class="{'bg-thirdcolor-400': currentPage === 'Fail', 'bg-maincolor-200': currentPage !== 'Fail'}"
    ...
    <div
      class="bg-thirdcolor-400 pt-5 rounded-b-lg"
      :is="currentPage"
